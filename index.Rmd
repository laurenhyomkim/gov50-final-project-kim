...
# Assuming high levels are defined (e.g., Anxiety > 7, Depression > 7, etc.)
# Adjust these values as per your specific criteria
high_levels <- survey_data |>
  filter(Anxiety > 7, Depression > 7, Insomnia > 7, OCD > 7)

# Analyzing music genre preferences
# Assuming genres are in columns like 'Frequency [Genre]'
...
# Assuming 'Depression' is already a numeric variable
# and 'Frequency [Rock]' is a categorical variable that needs to be converted into a numeric scale

# Convert 'Frequency [Rock]' into numeric values
survey_data <- survey_data |>
...
# Remove rows with NA in 'Depression' or 'Frequency [Rock]'
